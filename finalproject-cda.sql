...
-- Listage des données de la table finalprojectcda.user : ~1 rows (environ)
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `profile_picture`, `is_verified`) VALUES
	(1, 'test@test.fr', '[]', '$2y$13$4F2sY7K6q29c6ibFSnZvieI09gZqw61TLPdGujXCixMuniFwSMjk6', NULL, 0);
